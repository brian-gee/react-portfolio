  ...
  return (
      <footer className="pt-20 mt-auto">
          <div className="text-5xl flex justify-center py-3 text-gray-600 space-x-10">
            <a className='hover:text-blue-400 focus:shadow-outline focus:outline-none' href="https://www.linkedin.com/in/brian-geertsma-983052240/"><BsLinkedin /></a>
            <a className='hover:text-blue-400 focus:shadow-outline focus:outline-none' href="https://github.com/brian-gee"><BsGithub  /></a>
          </div>
